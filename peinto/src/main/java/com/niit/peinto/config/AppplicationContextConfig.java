package com.niit.peinto.config;
...
import com.niit.peinto.model.BillingAddress;
import com.niit.peinto.model.CardDetail;
...
public class AppplicationContextConfig {
	...
	public DataSource getDataSource() {
	    ...
	    dataSource.setUrl("jdbc:h2:tcp://localhost/~/jaffa");
